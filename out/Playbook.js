...
function Content(props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, elements.map(function (element, index) {
        var _a;
        return (react_1.default.createElement("section", { key: (_a = element.key, (_a !== null && _a !== void 0 ? _a : index)), className: 'playbook__content' },
            react_1.default.createElement("div", { className: 'playbook__preview' },
                react_1.default.createElement(ErrorBoundary, null, element)),
